...
__all__ = ['get_followers', 'get_new_followers', 'get_dif', 'get_followers_change', 'get_ads_status', 'save_ads_status',
           'get_updated_followers', 'more_stats', 'update_insights', 'save_dashboard_followers', 'save_followers',
           'make_change', 'save_change', 'update']
...
# Cell
def save_dashboard_followers(history_df: pd.DataFrame):
